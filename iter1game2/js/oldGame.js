...
window.onload = function() {
    ...
    function preload() {
        game.load.spritesheet( 'robin', 'assets/robinSpritesheet.png', 240, 314, 22);
    ...
    function create() {
       //Create the player and add arcade physics to it
        ...
        player.body.setSize((player.width - 25) / player.scale.x, (player.height/1.5 ) / player.scale.y, 40, player.height/2);
    ...
    function collisionOccured(){
        ...
        if(numLives == 0){
            ...
            game.add.text(game.world.centerX, game.world.centerY, "Game Over. Press Space to restart.", style);
